  ...
  sidebarNav: [
    {
      ...
      items: [
        ...
        { href: "/admin/flights", title: "Flight Management", icon: Plane, description: "Schedule new flights, assign crew, and manage flight details.", buttonText: "Manage Flights", statKey: "flights" },
    ...
    },
     {
      ...
      items: [
        ...
        { href: "/admin/quizzes", title: "Quiz Management", icon: CheckSquare, description: "View all quizzes and manage their associated questions.", buttonText: "Manage Quizzes", statKey: "quizzes" },
      ]
    },
    {

      ...
      <AnimatedCard delay={0.1}>
        <Card className="shadow-md">
          ...
          <CardContent className="text-sm text-muted-foreground space-y-2">
              <p>Our AI model processes operational data (provided as JSON), including safety reports and incident logs, to identify patterns, potential risks, and areas for improvement.</p>
              ...
              <p className="font-semibold">Use the "Load Sample Data" button in the tool above to see an example of the expected JSON structure.</p>
              <p className="font-semibold">Note: The data used for analysis is illustrative. In a real-world scenario, this tool would integrate with live operational databases for automated data ingestion.</p>
          </CardContent>
        </Card>
      </AnimatedCard>
    </div>

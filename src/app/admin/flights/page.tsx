                    ...
                    <Form {...form}>
                        ...
                        <ScrollArea className="h-[70vh] p-4">
                            ...
                            <h3 className="text-lg font-medium flex items-center gap-2"><Users />Crew Assignment</h3>
                             ...
                             <FormField control={form.control} name="cabinCrewIds" render={({ field }) => (<FormItem><FormLabel>Assign Cabin Crew</FormLabel><CustomMultiSelectAutocomplete placeholder="Select cabin crew..." options={cabinCrew.map(c => ({value: c.uid, label: `${c.displayName} (${p.email})`}))} selected={field.value || []} onChange={field.onChange} /><FormMessage /></FormItem>)} />

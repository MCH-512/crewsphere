...
type SortableColumn = "userEmail" | "documentName" | "lastUpdatedAt";
type SortDirection = "asc" | "desc";

export default function AdminDocumentValidationPage() {
    ...
    const fetchDocuments = React.useCallback(async () => {
        ...
        try {
            ...
            toast({ title: "Loading Error", description: "Could not fetch user documents for validation.", variant: "destructive" });
        } finally {
            setIsLoading(false);
        }
    }, [toast]);

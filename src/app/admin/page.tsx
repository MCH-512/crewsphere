                ...
                <CardContent className="flex-grow flex flex-col justify-between">
                  ...
                  {section.stat && (
                    <div className="flex justify-end mb-3">
                       <Badge variant={section.isRequestManagement && section.stat.value && section.stat.value > 0 ? "destructive" : "secondary"}>
                  ...
                  <Button asChild className="w-full mt-auto">
                    <Link href={section.href}>
                      ...
                      {section.buttonText}
                      {section.isRequestManagement && stats.pendingRequests.value && stats.pendingRequests.value > 0 && !stats.pendingRequests.isLoading && (

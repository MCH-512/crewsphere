...
import { getTodayActivities, getTrainingStatus, getRequestsStatus, getTrainingChartData, getRequestsChartData, getDashboardHeroImage } from "@/services/dashboard-service";

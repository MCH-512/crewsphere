...
const cspHeader = `
    ...
    connect-src 'self' https://*.firebaseio.com wss://*.firebaseio.com https://firestore.googleapis.com https://identitytoolkit.googleapis.com https://storage.googleapis.com https://www.googleapis.com;
    frame-src 'self';
    object-src 'none';
    form-action 'self';
    base-uri 'self';
